...
class Car:
    ...
    def _car_rot_d(self,dpsi): # only _car_rotation difference
        ...
        self.sensor01 = self.canvas.create_line((self.c4,self.s01) , fill = self.color) # set new, rotated sensor-line
        self.canvas.delete(self.sensor03) # delete old sensor
        self.sensor03 = self.canvas.create_line((self.c4,self.s03) , fill = self.color) # set new, rotated sensor-line
        self.canvas.delete(self.sensor05) # delete old sensor
        self.sensor05 = self.canvas.create_line((self.c4,self.s05) , fill = self.color) # set new, rotated sensor-line
        self.canvas.delete(self.sensor07) # delete old sensor
        self.sensor07 = self.canvas.create_line((self.c4,self.s07) , fill = self.color) # set new, rotated sensor-line
        self.canvas.delete(self.sensor09) # delete old sensor
        self.sensor09 = self.canvas.create_line((self.c4,self.s09) , fill = self.color) # set new, rotated sensor-line
        self.canvas.delete(self.car_polygon) # delete old car
        self.car_polygon = self.canvas.create_polygon(self.c1, self.c2, self.c3, self.c4, self.c5, fill = self.color) # set new, rotated car
    ...
    def _car_rot(self,psi): # only rotation
        ...
        self.sensor09 = self.canvas.create_line((self.c4,self.s09) , fill = self.color) # set new, rotated sensor-line
        self.canvas.delete(self.car_polygon) # delete old car
        self.car_polygon = self.canvas.create_polygon(self.c1, self.c2, self.c3, self.c4, fill = self.color) # set new, rotated car
    ...
    def _sensor_rot(self,delta):
        ...
        # update sensor data
        self.canvas.delete(self.sensor01) # delete old sensor
        self.sensor01 = self.canvas.create_line((self.c4,self.s01) , fill = self.color) # set new, rotated sensor data
        self.canvas.delete(self.sensor03) # delete old sensor
        self.sensor03 = self.canvas.create_line((self.c4,self.s03) , fill = self.color) # set new, rotated sensor data
        self.canvas.delete(self.sensor05) # delete old sensor
        self.sensor05 = self.canvas.create_line((self.c4,self.s05) , fill = self.color) # set new, rotated sensor data
        self.canvas.delete(self.sensor07) # delete old sensor
        self.sensor07 = self.canvas.create_line((self.c4,self.s07) , fill = self.color) # set new, rotated sensor data
        self.canvas.delete(self.sensor09) # delete old sensor
        self.sensor09 = self.canvas.create_line((self.c4,self.s09) , fill = self.color) # set new, rotated sensor data
    ...
    def set_car_pos(self,x,y,psi,delta): # set new car postion and angles (with zero velocities)
        ...
        self.car_center = self.canvas.create_bitmap(float(x), float(self.Y-y))

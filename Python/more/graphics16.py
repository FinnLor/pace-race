...
class car:
    ...
    def __init__(self,canvas,x,y,psi,delta,FACTOR,color):
        ...
        self.c4 = (x+self.cl/1.5, y) # create light_center of car
    ...
    def car_rot_d(self,dpsi): # only car_rotation difference
        #print("car_rot_d")
    ...
    def car_rot(self,psi): # only rotation
        ...
        self.s05 = (self.c4[0]+5*self.cl, self.c4[1]) # set sensor point no 05
...
class road:
    ...
    def __init__(self,canvas,FACTOR,WIDTH,HEIGHT,NPOINTS, ROADWIDTH):
        ...
        #xxx = road.simplify(1,True) # can be very usefull!!

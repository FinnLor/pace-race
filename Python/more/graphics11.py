...
class car:
    ...
    def __init__(self,canvas,x,y,psi,color):
        ...
        self.FAKTOR = 10 # dimension, e.g. FAKTOR=10 => 10pixel==1m
        self.canvas = canvas
        self.psi = psi # car_angle
        self.delta = 0 # car_front_wheel_angle
        self.color = color 
        self.dc = (0, 0) # velocity of car_center
        self.cl = 4 * self.FAKTOR # car length
        self.cw = 2 * self.FAKTOR # car width
...
# optional drawing of the current track with all cars and all sensors
...
win_track.mainloop() # REMARK: only nessecary for drawing window

...
void rtwdemo_secondOrderSystem_initialize(void)
{
  ...
  /* External mode info */
  rtwdemo_secondOrderSystem_M->Sizes.checksums[0] = (4128024334U);
  rtwdemo_secondOrderSystem_M->Sizes.checksums[1] = (2891005844U);
  rtwdemo_secondOrderSystem_M->Sizes.checksums[2] = (2965961217U);
  rtwdemo_secondOrderSystem_M->Sizes.checksums[3] = (684943490U);
